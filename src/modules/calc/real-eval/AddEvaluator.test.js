...
const zeroSequences: Array<[string, string, Array<ZeroTuple>]> = [
  [
    ...
    [
      ...
      [new RegularPrec(-1), new ZeroResult(true)],
      [new RegularPrec(0), new NonZeroResult(true, new RegularSize(1))],
      [new RegularPrec(5), new NonZeroResult(true, new RegularSize(1))],
      [new RegularPrec(8), new NonZeroResult(true, new RegularSize(1))],
  ...
  [
    ...
    [
      [new NegInfPrec(), new ZeroResult(true)],
      [new RegularPrec(-1), new ZeroResult(true)],
      [new RegularPrec(0), new NonZeroResult(true, new RegularSize(0))],
  ...
  [
    ...
    [
      ...
      [new RegularPrec(5), new NonZeroResult(false, new RegularSize(1))],
      [new RegularPrec(8), new NonZeroResult(false, new RegularSize(1))],
  ...
  [
    ...
    '-0.00014484',
    [
      [new RegularPrec(5), new ZeroResult(true)],
      [new RegularPrec(6), new NonZeroResult(true, new RegularSize(-6))],
      [new RegularPrec(7), new NonZeroResult(true, new RegularSize(-6))],
      [new RegularPrec(10), new NonZeroResult(true, new RegularSize(-6))],
